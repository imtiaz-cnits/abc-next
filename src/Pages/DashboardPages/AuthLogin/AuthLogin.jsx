...
const AuthLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://api.abcpabnabd.com/api/v1/SignUP", {
        method: "POST",
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://api.abcpabnabd.com/api/v1/Login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchProtectedData = async () => {
    ...
    try {
      const response = await fetch("https://api.abcpabnabd.com/api/v1/dashboard", {
        method: "GET",
        headers: {
