              ...
              <div className="special_product">
                ...
                <div className="special_product_card">
                  <div className="product">
                    ...
                    <span className={`special_product_status`}>In Stock</span>
                ...
                <div className="product_showing">
                  <div className="showing-entries">
                    <span id="display-info">
                      {`Showing ${(page - 1) * limit + 1}-${page * limit > filteredProducts?.length
                  ...
                  >
                    <div className="special_product_card">
                      <div className="product">
                        ...
                        <span className={`product_status ${!product?.stock ? "sold_out" : ""}`}>{!product?.stock ? "Out Of Stock" : "In Stock"}</span>
